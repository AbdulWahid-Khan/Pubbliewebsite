    ...
    return (
        <>
            <div>
                ...
                <div className={` ${Tab === 1 ? "block flex flex-col mg:flex-row mt-3 items-center justify-between mg:mt-[70px]  max-w-[1700px] w-full " : "hidden"} `}>

                    <img src={accountholderpic} alt="" className=' w-[160px[ h-[160px]' />

                    <div className="data max-w-[1700px] mt-3 w-full flex flex-col gap-4 px-5">
                        <div className="firstrow flex flex-row max-w-[1700px] w-full gap-4 justify-between">
                            <p className='flex lg:gap-2 bg-[rgba(250,250,250,1)] w-[460px]  py-3 pl-4'>
                                <IoPersonOutline />
                        ...
                        <p className='flex gap-2 bg-[rgba(250,250,250,1)] lg:w-[460px]  py-3 pl-4'>
                            <IoPersonOutline />
                ...
                <div className={` ${Tab === 1 ? "block flex items-center mt-[20px] justify-center  lg:justify-end max-w-[1700px] w-full px-5 " : "hidden"} `}>
                ...
                <div className={` ${Tab === 2 ? "block mt-3 pl-2 lg-p-0 lg:mt-[70px] pr-4" : "hidden"} `}>
                    <div className="password border-b-[1px] border-[rgba(228,228,228,1)] pb-[34px]">
                        ...
                        <div className='flex justify-center lg:justify-end max-w-[1650px] w-full'>
                            <button className='w-[162px] rounded-[6px] p-3.5 text-white bg-black font-inter font-medium text-sm cursor-pointer'>Save changes</button>
                        </div>
