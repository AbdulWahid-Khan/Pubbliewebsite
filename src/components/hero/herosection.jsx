...
const Herosection = () => {
  return (
    <>
      <div className="outer">
        <div className="">
        <div className="main w-full relative min-h-[933px]  ">
          <img
              src={herotopspring}
              alt=""
            ...
            />
         <div className=" justify-self-center bg-Navyblue  opacity-[68%] blur-[100px] elipse w-[832px] h-[124px] rounded-[50%] "></div>
          <div className="main flex h-full w-full relative ">
            
            


            <div className="maintext relative flex items-center justify-center mx-auto  max-w-[817px] w-full max-h-[101px] h-full ">
              <p className="text-[35px] font-bold font-inter  leading-[114%] sm:text-[54px] sm:font-bold font-inter text-Black tracking-[1.08px] text-center  z-40 leading-[114%] absolute top-1  ">
                Transform Your Campaigns with{" "}
                <span className="text-Primary">Pubblie</span>
              </p>
            </div>
            <div className="w-full h-[130px] elipse  rounded-[50%] absolute top-[164px] left-1/2 -translate-x-1/2 z-20  bg-white "></div>
            <div className="absolute top-[230px] images flex w-full justify-center sm:justify-between gap-[40px] 2xl:gap-[80px] z-0 ">
            ...
            <div className="w-full h-[131px] elipse  rounded-[50%] absolute top-[450px] left-1/2 -translate-x-1/2 z-20  bg-white"></div>
            <p className="text-lg font-inter text-Grey absolute top-[496px] left-1/2 -translate-x-1/2 max-w-[800px] w-full text-center z-20">
              Connecting Advertisers and Influencers for Seamless Campaign
              Success.
            </p>
            <div className="button flex justify-center w-full absolute  top-[553px] left-1/2 -translate-x-1/2 z-20">
              <div className="button relative flex justify-between items-center  w-[320px] h-full  rounded-full bg-white">
                <button className="absolute left-0 bg-Primary max-w-[268px] h-[52px] w-full  rounded-full text-lg text-white font-Dmsans  shadow-[0px_30px_36px_rgba(53,121,246,0.62)]">
                  Create Account Now
                </button>
                <div className="w-[27px] h-[22px] bg-Primary absolute right-[42px]"></div>
                <button className="bg-Primary group group-hover:bg-white  absolute right-0 flex justify-center items-center  rounded-full text-lg text-white font-Dmsans w-[52px] h-[52px] cursor-pointer shadow-[0px_30px_36px_rgba(53,121,246,0.62)]">
                  <MdArrowOutward
                    alt=""
            ...
            <div className="bottomtextimages  flex justify-around absolute top-[650px] left-1/2 -translate-x-1/2 w-full pl-4 max-w-[1720px] w-full">
        ...
        <div className="z-30 absolute  bottom-0 w-full bg-linear-to-r from-[#3579F6] to-[#1F4790] h-[70px]">
